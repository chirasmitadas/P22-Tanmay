...
function setup() {
	...
	rope1=new Rope(bob1.body,roof,{x:-80,y:0});
	rope2=new Rope(bob2.body,roof,{x:-40,y:0});
	rope3=new Rope(bob3.body,roof,{x:0,y:0});
	rope4=new Rope(bob4.body,roof,{x:40,y:0});
	rope5=new Rope(bob5.body,roof,{x:80,y:0});
